...
| 19 | [`19_mc_prop_softmax_prev_2000k`](19_mc_prop_softmax_prev_2000k/) | MC Prop Softmax + PrevAction + **CHECK=1chip** | Softmax | payoff × invest 비율 | 2000k | 완주. 학습 말단 200게임 평가는 vs Rule mbb **-915**였지만, 별도 100k×3 교차검증 평균은 vs Rule mbb **+124.6** — 최종 모델 자체는 유의미 흑자 |
| 20 | [`20_mc_prop_softmax_pypokerengine`](20_mc_prop_softmax_pypokerengine/) | 19번 최종 모델 vs PyPokerEngine Random/Honest | 평가 전용 | 외부 오픈소스 봇 교차검증 | 10k / 100k | Honest 100k×3 평균 **+447.0 mbb/g**, Random 100k×3 평균 **+25.9 mbb/g** — 외부 봇 상대로도 유의미 흑자 확인 |
