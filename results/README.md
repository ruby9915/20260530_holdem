...
## 경쟁 처방 bake-off (= 31번, E8, 2026-07-06)

[`31_rival_bakeoff/`](31_rival_bakeoff/) — ZCA에 대한 표준 처방 후보 3종을 동일 규약(clean·single-TAG·2M·100k×5)으로 통제 비교. 러너 [`_run_rival_seed.py`](../poker-pokerkit-prev/_run_rival_seed.py) (`UNIFORM_PENALTY` 훅 신설, 낙관 초기화·온도 하한은 monkey-patch).

| 처방 (×seed 1-5) | vsRand | 양수 | vsTAG | 판정 |
|---|---|---|---|---|
...
> 논문 §5.5 신설. "비용 부여" 일반이 아니라 **비용 0 행동에 대한 선택성**이 처방의 본질임을 ③과의 대비로 분리 실증. 상세 실험일지 33절 보강 3.
