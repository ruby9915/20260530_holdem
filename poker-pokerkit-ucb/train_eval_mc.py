"""
train_eval_mc.py  (UCB ?먯깋 踰꾩쟾 ??Monte Carlo Q-?щ떇)
?????????????????????????????????????????????????????????????????????
?숈뒿 ?먮쫫:
...
# ?????????????????????????????????????????????????????
# ?먰뵾?뚮뱶 ?ㅽ뻾 (?숈뒿????MC + 利됯컖 鍮꾩슜 + UCB ?먯깋)
# ?????????????????????????????????????????????????????
def play_train_episode(ql: QLearning, learner_id: int = 0) -> float:
    """
    UCB濡??됰룞???좏깮?섍퀬 ?먰뵾?뚮뱶媛 ?앸궃 ??MC ??쟾?뚮줈 Q-?뚯씠釉??낅뜲?댄듃.
    immediate 蹂댁긽(踰좏똿/肄???移?蹂?붾웾)???몃젅?댁뒪??湲곕줉?섏뿬 ??쟾?뚯뿉 ?ы븿.
    """
    pk_state = _make_game()
