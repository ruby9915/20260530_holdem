...
| 행동 | Jackson 2013 (Slumbot NL) 축소판 | 등급 메뉴 (2026-07-15 확정 C안): **매 라운드 첫 벳 = A12 8종 {0.25–4}×팟**, 리레이즈 이상 {팟}+올인. 경위: 트리 level 버그(포스트플랍 첫 벳이 팟 1종으로 붕괴 — 번역 16–27%의 진범) 수정 → 전 지점 8종은 정보집합 1.6억(불가) → C안(1,200만) 채택 |
