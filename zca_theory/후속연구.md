...
[`후속_mdp설계_v2g_iot.md`](후속_mdp설계_v2g_iot.md) (지도교수 합동 미팅 제출용).

| 편 | 도메인 | 고유 기여 | 교신(안) | 상태 |
|---|---|---|---|---|
| 1 | 홀덤 (현 v3) | 계열 병리 명명·증명 + 임계 **존재** 실증 + 정직한 범위 규정 | 협의 | 개정 중 |
| 2 | V2G 스케줄링 | 요금표에서 ε_min **사전 계산 → 위치 예측** 검증 | 김선용 | MDP 설계 완료 |
| 3 | EH-IoT 전송 | VIC의 **물리적 실현**(sleep 대기전력=실재 비용) + 완전 통제 용량-반응 | 박승민 | MDP 설계 완료 |
