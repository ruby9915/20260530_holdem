...
수치 검증: analyze_qcheck.py 직접 측정 + clean 재현런(results/ablation_vic_2m_clean) + 누수 격리(LEAKON).
...
<!-- 형식 증명: toy_zca_proof.md · 진단: ../poker-pokerkit-prev/analyze_qcheck.py · clean 재현: ../results/ablation_vic_2m_clean · 누수 격리: mixed_vic_off_LEAKON -->
